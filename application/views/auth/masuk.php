...
<head>
    ...
    <!-- Begin SEO tag -->
    <title> Halaman Masuk | Kalla Kars </title>
    ...
    <meta property="og:site_name" content="Halaman Masuk | Kalla Kars">
    <script type="application/ld+json">
        {
            "name": "Admin - Kalla Kars",
    ...
    <link rel="shortcut icon" href="<?= base_url(); ?>assets/kalla/icon_kalla.png">
    ...
    <main class="auth auth-floated">
        ...
        <form action="<?= base_url('auth'); ?>" method="post" class="auth-form">
            <fieldset>
                <div class="mb-4 mt-5">
                    <div class="mb-5">
                        <img class="rounded" src="<?= base_url('assets/kalla/Kalla.png') ?>" alt="" width="300">
                    </div>
        ...
        <!-- .auth-announcement -->
        <div id="announcement" class="auth-announcement" style="background-image: url(assets/kalla/masuk.png);">
