...
<head>
    ...
    <!-- Begin SEO tag -->
    <title> Sesi telah berakhir | Crown Hunter </title>
    ...
    <main class="auth">
        <header id="auth-header" class="auth-header" style="background-image: url(assets/images/illustration/img-1.png);">
            <h1>
                ...
                </svg> <span class="sr-only">Layar terkunci</span>
            </h1>
            <div class="container">
                <p> Sesi kamu telah berakhir, tolong masukkan password atau <a href="<?= base_url('auth/logout'); ?>">Keluar</a>
                </p>
            </div>
        </header><!-- form -->
        <form class="auth-form needs-validation" novalidate="" action="<?= base_url('auth/lockscreen'); ?>" method="post">
            <div class="text-center mb-4">
                <!-- .user-avatar -->
                <div class="user-avatar user-avatar-xl mb-3">
                    <img src="<?= base_url('assets/images/avatars/') . $user['image']; ?>" alt="">
                </div><!-- /.user-avatar -->
            ...
            <div class="form-group">
                <div class="input-group input-group-md circle">
                    <input type="password" id="validationTooltipUsername" name="password" class="form-control" aria-describedby="inputGroupPrepend" placeholder="Password" autofocus="true" required="">
                    <div class="input-group-prepend">
                        <button class="btn btn-reset mr-2 text-primary" type="submit"><i class="fa fa-arrow-circle-right"></i></button>
                    </div>
                    <div class="invalid-tooltip"> Tolong isi password anda. </div>
                </div>
            </div><!-- /.form-group -->
        </form><!-- /.auth-form -->
        <!-- copyright -->
